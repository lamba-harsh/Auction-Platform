    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        ...
        <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
            <div>
                ...
                <p class="text-left text-gray-500 text-white">Run an online auction as a stand-alone fundraiser or as part of a live event.</p>
            </div>
            <div>
                <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                ...
                <p class="text-left text-gray-500 text-white">Run a fundraising auction for your school with donations from parents and supporters</p>
            </div>
            <div>
                <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                ...
                <p class="text-left text-gray-500 text-white">Auction surplus stock, offer deals to employees or raise money for a good cause</p>
            </div>
            <div>
                <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                ...
                <p class="text-left text-gray-500 text-white">Run online auction for technical products</p>
            </div>
            <div>
                <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                ...
                <p class="text-left text-gray-500 text-white">Raise money for a business venture, an expedition, or any other worthy cause</p>
            </div>
            <div>
                ...
                <p class="text-left text-gray-500 text-white">Raise money for a sporting or social club - perhaps together with a live event.</p>
            </div>
        </div>
    </div>
  </section>
